...
export function MainContent() {
  return (
    <section id="sobre-mi" className="relative py-16 overflow-hidden bg-teal-600">
      <article className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
        <section className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <header className="relative z-10 mb-8 lg:mb-0 lg:-mt-20 lg:ml-10">
            ...
            <p className="text-xl text-teal-100 leading-relaxed mb-8 max-w-2xl">
              Soy Johan Delgado, estudiante de Ingeniería de Software, apasionado
          ...
          <figure className="relative lg:mt-0 flex justify-center">
            <figcaption className="sr-only">Foto de perfil de Johan Delgado</figcaption>
            <div
      ...
      <section
        className="relative"
        style={{
          height: "200px", // Alto personalizado para la onda
        }}
      >
        <svg
